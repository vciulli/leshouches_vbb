...
\subsubsection{Z+b(b) production with \Sherpa}
\begin{figure}[htbp]
...
\subsubsection{Z+b(b) production with \Herwig}
\label{sec:ZHerwig}
...
\subsubsection{W+b production with \Sherpa}
...
\subsubsection{W+bb production with \Herwig}
\label{sec:WHerwig}
