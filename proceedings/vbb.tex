...
\caption{{\em FIXME:REMOVE ONE PLOT OR ADD Z PT?} A selection of the plots comparing rescaled Sherpa 4F NLO predictions to ATLAS results.}
...
\end{center}
\caption{Differential \pt distribution of the b-jet in $W+b$ events with a single jet (left) or with two jets (right). Superimposed are
shown the predictions from Sherpa $W+b\bar{b}j$. {\em FIXME: SHERPA IS LO/NLO? REMOVE HERWIG FROM THESE PLOTS? ADD ALSO RATE PLOT HERE OR REMOVE EVERYWHERE?}
}
\label{wbb-pt-sherpa}
\end{figure}
