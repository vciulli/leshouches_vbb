...
\subsubsection{W+b(b) with \Herwig}
\label{sec:WHerwig}

A selection of results for the 4F, Wbb setup (as described in
section~\ref{subsubsec:herwigsetup}) is shown in
figures~\ref{wbb-njet-herwig} and~\ref{wbb-pt-herwig}.

\begin{figure}[htbp]
\begin{center}
   \includegraphics[scale=0.65]{figs/wbb/herwig/atlas-d01-x01-y02.pdf}
\end{center}
