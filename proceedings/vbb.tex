...
For this study the relevant tree--level matrix elements are provided by
\MadGraph\_\MCatNLO~\cite{Alwall:2011uj,Alwall:2014hca} (at the level of
color--ordered subamplitudes), whereas the relevant tree--level/one--loop
interference terms are provided by
...
as subtractive (NLO$\oplus$) and multiplicative (NLO$\otimes$) matching --
based on the MC@NLO~\cite{Frixione:2002ik} and POWHEG~\cite{Nason:2004rx}
formalism respectively -- for the systematic and consistent combination of
NLO QCD calculations with both shower
variants~\cite{Gieseke:2003rz,Platzer:2009jq} in \Herwig.
...
All the details of the {\tt Wbbj} code in the \POWHEGBOX{} framework
can be found in ref.~\cite{Luisoni:2015mpa}. Here we briefly summarize them.
\begin{enumerate}
